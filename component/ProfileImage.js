...
const ProfileImage = ({uri, style}) => {
  ...
  return (
    <FastImage
      source={{uri: uri || defaultImageUrl}}
      style={{height: 100, width: 100, borderRadius: 50, margin: 10, ...style}}
      resizeMode={FastImage.resizeMode.cover}
    />
  );
};

ProfileImage.propTypes = {uri: PropTypes.string, style: PropTypes.object};
